...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#"> Job Portal Management System </a></span></h2>
				<h3><marquee style="color: crimson;"> Team S.S.R Welcomes You To Our Job Portal System</marquee></h3>
              ...
              <p align="right"> <img src="design/123.webp" alt="" width="480" height="400 " /></p>
              <p style="text-align: center; color: teal;">"You Are Hired"</p>
